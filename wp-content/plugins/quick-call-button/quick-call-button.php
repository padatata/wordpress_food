...
define('QUICK_CALL_BUTTON_VERSION', '1.2.5');
...
class LV_Quick_Call_Button
{
	...
	function lv_admin_scripts() {
		...
		if (get_current_screen()->base == 'settings_page_lv_quick_call_button') {
	        wp_register_script( 'lv_js', plugins_url('assets/js/quick-call-button-admin.js', __FILE__), array('jquery'), '1.2.5', true );
	        wp_enqueue_script( 'lv_js' );
			wp_register_style( 'lv_css', plugins_url('/assets/css/quick-call-button-admin.css', __FILE__) , false, '1.2.5' );
	...
	function lv_add_buttons() {
		...
		if ($this->lv_mandatory_have_info()) {
			...
			wp_register_style( 'lv_css', QUICK_CALL_BUTTON_URL."assets/css/quick-call-button.css",array(),"1.2.5" );
			wp_enqueue_style( 'lv_css');
